...
func main() {
    ...
    paddedAddress := common.LeftPadBytes(toAddress.Bytes(), 32) //data切片的每个参数都要编码成 32字节对齐的十六进制表示。
    ...
    tx := types.NewTransaction(nonce, tokenAddress, value, 90000, gasPrice, data)
